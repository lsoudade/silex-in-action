...
class AccountPasswordForm extends Form
{
    ...
    public function build(array $data = null)
    {
        ...
        $builder->add('password', 'repeated', array(
            'type'            => 'password',
            'required'        => true,
            'first_options'   => array('label' => 'form.account.password', 'attr' => array('class' => 'form-control', 'autocomplete' => 'off')),
            'second_options'  => array('label' => 'form.account.password.again', 'attr' => array('class' => 'form-control', 'autocomplete' => 'off')),
